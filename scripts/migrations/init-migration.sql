...
-- Enumerated Types
CREATE TYPE IF NOT EXISTS user_role AS ENUM ('STUDENT', 'CFI', 'SCHOOL_ADMIN');
CREATE TYPE IF NOT EXISTS part_61_or_141_type AS ENUM ('PART_61', 'PART_141');
CREATE TYPE IF NOT EXISTS processing_status AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'COMPLETED_WITH_ERRORS');
CREATE TYPE IF NOT EXISTS subscription_status AS ENUM ('ACTIVE', 'CANCELED', 'PAST_DUE', 'INCOMPLETE', 'INCOMPLETE_EXPIRED', 'TRIALING');
CREATE TYPE IF NOT EXISTS link_established_status AS ENUM ('ACTIVE', 'INACTIVE');
CREATE TYPE IF NOT EXISTS invitation_status AS ENUM ('PENDING', 'ACCEPTED', 'DECLINED', 'EXPIRED');
CREATE TYPE IF NOT EXISTS invitation_target_entity_type AS ENUM ('STUDENT_CFI_LINK', 'CFI_SCHOOL_LINK', 'STUDENT_SCHOOL_LINK', 'NEW_USER_REGISTRATION');

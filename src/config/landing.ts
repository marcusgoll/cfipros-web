...
import { BookOpen, BarChart2, Users, Zap, Lightbulb, CheckCircle, ListChecks, FileText, Rocket, ShieldCheck, HelpCircle, User, Building, UserCircle } from "lucide-react"; // Added ChevronDown, Building, UserCircle
...
export interface NavItem {
  ...
  export const topbarAuthNavItems = (isLoggedIn: boolean): NavItem[] => (
    isLoggedIn
      ? [
          { label: "Dashboard", href: "/dashboard", isButton: true, variant: "brand-outline", className: "font-bold rounded-md mb-1 sm:mb-0" },
        ]
      : [
          { label: "Log In", href: "/login", isButton: true, variant: "ghost", className: "text-brand-light/80 hover:text-brand-light hover:bg-white/10" },
          { label: "Get Started", href: "/sign-up", isButton: true, variant: "brand-outline", className: "font-bold rounded-md mb-1 sm:mb-0" },
        ]
  );
  
  export const topbarIconNavItems: NavItem[] = [
      { label: "Help", href: "/help", Icon: HelpCircle, className:"text-brand-light/70 hover:text-brand-light hover:bg-white/10" },
      { label: "Profile", href: "/profile", Icon: User, className:"text-brand-light/70 hover:text-brand-light hover:bg-white/10" },
  ];
...
export const faaKnowledgeExtractor = {
  ...
  description: "Paste text from an FAA document or enter a topic, and let our AI extract key information for you. A powerful tool for CFIs and students alike, available for free to get a taste of CFIPros.",
  ...
  example: {
    ...
    results: [
      ...
      { point: "Content: Basic pilot skills, transitioning to different airplanes, Fundamentals of Instruction." },
      { point: "Audience: Pilots, CFIs, CFI applicants." },
    ],
    valueProposition: "Valuable Insights: Quickly grasp the core concepts of any FAA text, identify key regulations, or understand procedural steps without sifting through pages of content. Our tool highlights what's important, saving you time and effort."
  }
};
...
export const roadmapItems = [
  {
    ...
    description: "Deeper insights into student learning patterns and predictive performance indicators.",
    Icon: BarChart2,
    status: "Planned",
  },
  {
  ...
  },
  {
    ...
    description: "Features specifically designed for compliance and record-keeping for flight schools.",
    Icon: ShieldCheck,
    status: "Researching",
  }
];
...
export const cfiFeatures = [
  { title: "Automated Knowledge Extraction", Icon: FileText, description: "Quickly generate study guides and lesson notes from FAA texts." },
  { title: "Efficient Lesson Planning", Icon: Lightbulb, description: "Streamline your prep time with AI-assisted content generation." },
  { title: "Identify Student Weak Spots", Icon: CheckCircle, description: "Use data to focus on areas needing the most attention (Future Feature)." },
  { title: "Centralized Resources", Icon: Rocket, description: "Keep all your teaching materials and student records in one place (Future Feature)." },
];

export const schoolFeatures = [
  { title: "Standardized Training Content", Icon: FileText, description: "Ensure consistency across all instructors with centralized curriculum tools (Future Feature)." },
  { title: "Compliance & Reporting", Icon: CheckCircle, description: "Simplify record-keeping and reporting requirements (Future Feature)." },
  { title: "Instructor Performance Overview", Icon: BarChart2, description: "Gain insights into instructor activity and student outcomes (Future Feature)." },
  { title: "Scalable Training Operations", Icon: Rocket, description: "Tools designed to grow with your flight school (Future Feature)." },
];

export const pricing = {
  title: "Simple, Transparent Pricing",
  betaTitle: "Currently Free in Beta!",
  betaDescription: "All features of CFIPros are completely free to use while we are in Beta. Help us shape the future of flight training!",
  postBetaTeaser: "Future pricing will be designed to be affordable for individual CFIs and scalable for flight schools. Stay tuned for updates.",
};

export const cta = {
  title: "Ready to Elevate Your Flight Instruction?",
  description: "Join the CFIPros beta today and experience the next generation of flight training tools. It's free, powerful, and built for you.",

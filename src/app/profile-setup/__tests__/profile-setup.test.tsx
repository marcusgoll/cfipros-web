...
const createMockSearchParams = (role) => ({
  get: jest.fn((param) => {
...
describe('ProfileSetupPage Integration', () => {
  ...
  it('loads correctly and sets CFI role from URL parameter', async () => {
    ...
    require('next/navigation').useSearchParams.mockReturnValue(createMockSearchParams(mockRoles.cfi));
  ...
  it('loads correctly and sets School Admin role from URL parameter', async () => {
    ...
    require('next/navigation').useSearchParams.mockReturnValue(createMockSearchParams(mockRoles.schoolAdmin));
  ...
  it('submits form and creates profile with School Admin role and school record', async () => {
    ...
    expect(mockRouter.replace).toHaveBeenCalledWith('/dashboard/cfi/subscribe-guidance?type=school');
  });

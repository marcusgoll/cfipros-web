            ...
            <div className="p-8">
              <div className="flex flex-col items-center text-center mb-8">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Start for <span className="text-highlight">free</span>, upgrade when you&apos;re ready
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-3">
                  <h3 className="text-lg font-bold border-b border-border pb-2">Included in Free</h3>
                ...
                <div className="space-y-3">
                  <h3 className="text-lg font-bold border-b border-border pb-2">Premium Features</h3>
                  <ul className="space-y-2">
                    {[
                      "Unlimited students",
                      "Advanced analytics",

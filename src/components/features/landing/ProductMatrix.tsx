      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-[600px]">
            Our ACS Extractor tool provides comprehensive analysis of FAA Knowledge Test results to improve training outcomes.
          </p>
        </div>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold mb-2 transition-colors hover:text-highlight">{feature.name}</h3>
            ...
            <div className="md:w-1/2 space-y-4">
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-2">
                  <div className="bg-highlight rounded-full h-6 w-6 flex items-center justify-center shrink-0 mt-0.5 text-white font-medium text-sm">1</div>
                  <div>
                    <span className="font-medium">Upload your FAA Knowledge Test results PDF</span>
                    <p className="text-sm text-muted-foreground">Simply drag and drop your test results or upload from your device.</p>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  <div className="bg-highlight rounded-full h-6 w-6 flex items-center justify-center shrink-0 mt-0.5 text-white font-medium text-sm">2</div>
                  <div>
                    <span className="font-medium">Our system extracts and analyzes the data</span>
                    <p className="text-sm text-muted-foreground">Advanced algorithms map each question to ACS codes and analyze performance.</p>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  <div className="bg-highlight rounded-full h-6 w-6 flex items-center justify-center shrink-0 mt-0.5 text-white font-medium text-sm">3</div>
                  <div>
                    <span className="font-medium">Review comprehensive analytics</span>
                    <p className="text-sm text-muted-foreground">View detailed breakdowns by ACS area and identify weak points to focus training.</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="md:w-1/2 bg-card border border-border rounded-lg p-4">
              ...
              {uploadState === 'success' && (
                <div className="flex flex-col items-center justify-center p-8">
                  ...
                  <p className="text-sm text-muted-foreground text-center mb-4">
                    We're analyzing your test results. You'll receive a comprehensive report shortly.
                  </p>
                  <Button 
                    variant="outline" 
                    className="mt-2"

...
const valueCards = [
  {
    ...
    description:
      'Eliminate manual paperwork and tedious record-keeping with digital solutions that save time and reduce errors.',
  ...
  },
  {
    ...
    description:
      "Improve student outcomes with data-driven insights that identify knowledge gaps and focus training where it's needed most.",
  ...
  },
  {
    ...
    title: 'Grow Revenue',
    description:
      'Increase completion rates, optimize resources, and expand your capacity to train more students effectively.',
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-[600px]">
            Our platform transforms how flight schools operate, improving outcomes for students and
            instructors.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {valueCards.map((card) => (
            ...
            >
              {/* Background gradient */}
              <div
                className={`absolute top-0 left-0 right-0 h-24 bg-gradient-to-b ${card.color} -z-10`}
              />

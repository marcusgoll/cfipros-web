                      ...
                      >
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal cursor-pointer">
                            ...
                            <p className="text-sm text-gray-500">I'm learning to fly and preparing for FAA tests</p>
                          </FormLabel>
                        </FormItem>
                        ...
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal cursor-pointer">
                            ...
                            <p className="text-sm text-gray-500">I teach students and create lesson plans</p>
                          </FormLabel>
                        </FormItem>
                        ...
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal cursor-pointer">
                            ...
                            <p className="text-sm text-gray-500">I manage a flight school and its instructors</p>
                          </FormLabel>
                        </FormItem>
                      </RadioGroup>
                    </FormControl>
